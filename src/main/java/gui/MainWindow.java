...
public class MainWindow {
    ...
    private void createAndShowGUI() {
        ...
        String iconPath = "src/main/resources/images/mainIcon.jpg";
    ...
    private void addCountdownLabel(Container container, GridBagConstraints gbc) {
        JLabel countdownLabel = new JLabel(countdown);
        countdownLabel.setFont(new Font("Arial", Font.PLAIN, 18));
        gbc.gridx = 0;
        gbc.gridy = 0;
        ...
        container.add(countdownLabel, gbc);
    }
